/*!
 * Miningcore.js v2.1 - Mobile Optimized Version
 * Fixed: Navigation, data loading, mobile responsiveness, touch events
 */
...
// Enhanced home page loader with mobile optimization - Removed algorithm filters
...
// Load Miner Payments - Mobile optimized
function loadPaymentsMinerPage(walletAddress) {
    return $.ajax(API + "pools/" + currentPool + "/miners/" + walletAddress + "/payments?page=0&pageSize=50")
        .done(function(data) {
            var payoutsList = "";
...
// Load Miner Earnings - Mobile optimized
function loadEarningsMinerPage(walletAddress) {
    return $.ajax(API + "pools/" + currentPool + "/miners/" + walletAddress + "/balancechanges?page=0&pageSize=30")
        .done(function(data) {
            var earningsList = "";
